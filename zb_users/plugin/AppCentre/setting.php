  ...
  <div id="divMain2">
            ...
            <?php echo '<input id="token" name="token" type="hidden" value="'.$zbp->GetToken('AppCentre').'"/>'?>
              <table width="100%" border="0">
                ...
                <tr height="32">
                  <td width="30%" align="left"><p><b>· 后台连接“应用中心”的方式</b><br/>
...
<label><input name="app_networktype" type="radio" value="filegetcontents" <?php echo $zbp->Config('AppCentre')->networktype=='filegetcontents'?'checked="checked"':'';?> />filegetcontents</label>&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr height="32">
                  <td width="30%" align="left"><p><b>· 后台访问“应用中心”的域名</b><br/>
                      <span class="note">&nbsp;&nbsp;如果不能连接请切换域名尝试</span></p></td>
                  <td>
<label><input name="app_firstdomain" type="radio" value="zblogcn.com" <?php echo $zbp->Config('AppCentre')->firstdomain=='zblogcn.com'?'checked="checked"':'';?> />app.zblogcn.com(默认)</label>&nbsp;&nbsp;&nbsp;&nbsp;
